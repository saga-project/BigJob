...
setup(name='BigJob2',
      ...
      packages=['bigjob', 'bigjob_dynamic', 'coordination', 'pilot', 'bigjob.job_plugin', 
		        'pilot.api','pilot.api.compute', 'pilot.api.data', 'pilot.coordination', 'pilot.iterative',
                'pilot.filemanagement', 'pilot.impl', 'pilot.scheduler', 'examples', 'bootstrap', 'cli'],
