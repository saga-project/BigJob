...
class SSHMemoryFileAdaptor(object):
    """ Pilot-Data for SSH-based File Management 
    
        Data will be stored in at an in-memory mount point
    
        ssh+mem://<hostname>/<mount
        
        Requires FUSE installation
    """
    ...
    def initialize_pilotdata(self):
        ...
        try:
            ...
            if self.host == "localhost":
                self.memory_filesystem = FUSE(Memory(), self.path, foreground=False)
