...
\""""]
        ...
        # output options
        jd.output = "BigJob_job.03.stdout"
        jd.error  = "BigJob_job.03.stderr"
    ...
    if failed == True:
      ...
      print "(2) Make sure the file BigJob_job.03.stdout exists"
      print "(3) Make sure BigJob_job.03.stdout contains:"
