...
def run(url, username, queue, project):
    ...
    try:
        ...
        # output options
        jd.output = "BigJob_job.02.stdout"
        jd.error  = "BigJob_job.02.stderr"
    ...
    if failed == True:
      ...
      print "(2) Make sure the file BigJob_job.02.stdout exists"
      print "(3) Make sure BigJob_job.02.stdout contains:"
