...
\""""]
        ...
        # output options
        jd.output = "BigJob_job.05.stdout"
        jd.error  = "BigJob_job.05.stderr"
    ...
    if failed == True:
      ...
      print "(2) Make sure the file BigJob_job.05.stdout exists"
      print "(3) Make sure BigJob_job.05.stdout contains:"
      print "  Hello from BigJob" 
